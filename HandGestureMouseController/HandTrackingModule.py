...
class FindHands:
    def __init__(self, max_hands = 2,detection_con=0.5, tracking_con=0.5):
        self.max_hands = max_hands
        self.mpHands = mp.solutions.hands
        self.hands = self.mpHands.Hands(max_num_hands=max_hands,min_detection_confidence=detection_con, min_tracking_confidence=tracking_con)
